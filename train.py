...
def train(log_dir, args):
  ...
  with tf.Session(config=config) as sess:
    try:
      ...
      #file_writer = tf.summary.FileWriter('logs-tacotron', sess.graph)
      while not coord.should_stop():
        ...
        #step % 10 == 0  # Record summaries and test-set accuracy
        #file_writer.add_summary(time_window.average, loss, loss_window.average , step)
